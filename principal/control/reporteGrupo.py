...
class reporteDeHorario(Report):
	...
	class band_detail(DetailBand):
            height=0.5*cm
            elements=[
                ObjectValue(attribute_name='grupo',top=5*cm, left=0.2*cm, style={'fontName': 'Helvetica', 'fontSize':8}),
                ObjectValue(attribute_name='materia.nombre',top=5*cm, left=1.2*cm, style={'fontName': 'Helvetica', 'fontSize':8}),
                ObjectValue(attribute_name='horario.lunes',top=5*cm, left=6.0*cm, style={'fontName': 'Helvetica', 'fontSize':8}),
                ObjectValue(attribute_name='horario.martes',top=5*cm, left=8.0*cm, style={'fontName': 'Helvetica', 'fontSize':8}),
                ObjectValue(attribute_name='horario.miercoles',top=5*cm, left=10*cm, style={'fontName': 'Helvetica', 'fontSize':8}),
                ObjectValue(attribute_name='horario.jueves',top=5*cm, left=12*cm, style={'fontName': 'Helvetica', 'fontSize':8}),
                ObjectValue(attribute_name='horario.viernes',top=5*cm, left=14*cm, style={'fontName': 'Helvetica', 'fontSize':8}),
                ]
